      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
...

        {
          appointments.reverse().map((item, index) => (
            <div className='flex flex-warp justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items.center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
